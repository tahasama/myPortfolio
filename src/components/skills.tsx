...
const Skills = () => {
  ...
  const bglCardHead = useColorModeValue("blue.900", "gray.400");
  const bglCardHead2 = useColorModeValue("blue.700", "gray.400");
  ...
  return (
    <Box mt={[-10, -14, -24, -40]}>
      ...
      <Box bgColor={colorMode !== "light" ? "#171923" : "#9DECF9"}>
        ...
        >
          <defs>
            <linearGradient id="wave-gradients" gradientTransform="rotate(90)">
              <stop
                stopColor={colorMode !== "light" ? "#1A202C" : "#90CDF4"}
                offset="0%"
              ></stop>
              <stop
                stopColor={colorMode !== "light" ? "#171923" : "#90CDF4"}
                offset="100%"
              ></stop>
            </linearGradient>
          </defs>
      ...
      >
        ...
        >
          <Flex
            ...
            m={[0, 0, 0, "2"]}
            w={["80px", "80px", 100]}
            transform={["scale(.6)", "scale(.8)", "scale(1)"]}
          >
            <Flex
              clipPath={
